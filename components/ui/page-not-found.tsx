...
function MessageDisplay() {
  ...
  return (
    <div className="absolute flex flex-col justify-center items-center w-[90%] h-[90%] z-100">
      ...
      >
        <div className="text-[35px] font-semibold text-foreground m-[1%]">
          Page Not Found
        </div>
        <div className="text-[80px] font-bold text-primary m-[1%]">404</div>
        ...
        <div className="flex gap-6 mt-8">
          <button
            onClick={() => router.back()}
            className="text-foreground border-2 border-foreground hover:bg-foreground hover:text-background transition-all duration-300 ease-in-out px-6 py-2 h-auto text-base font-medium flex items-center gap-2 hover:scale-105"
          >
            <svg
          ...
          <button
            onClick={() => router.push("/")}
            className="bg-primary text-primary-foreground hover:bg-primary/90 transition-all duration-300 ease-in-out px-6 py-2 h-auto text-base font-medium flex items-center gap-2 hover:scale-105"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
...
function CircleAnimation() {
  ...
  const draw = (canvas: HTMLCanvasElement, fillColor: string) => {
    ...
    requestIdRef.current = requestAnimationFrame(() => draw(canvas, fillColor));
  };
  ...
  useEffect(() => {
    ...
    // Read the theme's primary color from CSS custom properties
